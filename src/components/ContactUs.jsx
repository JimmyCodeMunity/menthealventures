...
const ContactUs = () => {
    return (
        <div>
            <section class="w-full xl:py-24 lg:py-20 py-12 bg-white border-b border-gray-300">
          <div class="w-full max-w-7xl px-6 lg:px-8 mx-auto">
            <div class="grid lg:grid-cols-2 grid-cols-1 gap-x-16 xl:gap-x-24 gap-y-14 max-w-lg md:max-w-3xl lg:max-w-full mx-auto">
              <div>
                <h1 class="font-manrope text-gray-900 md:text-5xl text-4xl font-bold leading-tight mb-8 lg:text-left text-center">Contact Us</h1>
                <p class="text-gray-900 text-lg font-normal leading-7 lg:text-left text-center">We're here to assist you! Whether you have questions, feedback, or inquiries, our team is ready to help.</p>
                <div class="my-12 grid md:grid-cols-2 grid-cols-1 md:gap-x-8 gap-y-8">
                  <div class="rounded-2xl border border-gray-200 bg-white p-7 group transition-all duration-500 hover:bg-gray-900">
                    <a href="javascript:;" class="w-14 h-14 bg-black rounded-full flex items-center justify-center mb-5 transition-all duration-500 group-hover:bg-white cursor-pointer">
                      <svg class="fill-white transition-all duration-500 group-hover:fill-indigo-600" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="rounded-2xl border border-gray-200 bg-white p-7 group transition-all duration-500 hover:bg-amber-300">
                    <a href="javascript:;" class="w-14 h-14 bg-black rounded-full flex items-center justify-center mb-5 transition-all duration-500 group-hover:bg-white cursor-pointer">
                      <svg class="stroke-white transition-all duration-500 group-hover:stroke-indigo-600" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h5 class="text-gray-900 text-xl font-semibold leading-8 mb-3 transition-all duration-500 group-hover:text-white">Mentheal Support</h5>
                    <p class="text-gray-500 text-sm font-normal leading-5 transition-all duration-500 group-hover:text-white">Chat with our support team incase anything comes up.We are always ready to help. </p>
                  </div>
                </div>
                <div class="border-t border-slate-200 pt-12 flex lg:justify-start justify-center">
                  <div class="flex gap-x-1 border-r border-indigo-300 items-center">
                    ...
                    <a href="javascript:;" class="text-indigo-900 text-lg font-normal leading-7 pl-2.5 pr-3.5">4.9 Rating</a>
                  </div>
                  <a href="javascript:;" class="pl-3.5 text-indigo-900 text-lg font-normal leading-7">163 Reviews on <span class="text-emerald-500"> Trustpilot </span>
                  </a>
                </div>
              </div>
              <form action="" class="h-fit bg-white border border-slate-200 rounded-2xl lg:p-12 p-8 w-full max-w-lg md:max-w-3xl lg:max-w-full mx-auto">
                <div class="relative mb-8">
                  <label class="flex  items-center mb-2 text-gray-600 text-base leading-6 font-medium">Name </label>
                  <div class="relative text-gray-500 focus-within:text-gray-900">
                    ...
                    <input type="text" id="default-search" class="w-full block h-12 pr-5 pl-12 py-2.5 text-lg leading-7 font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-full placeholder-gray-400 focus:outline-none" placeholder="harsh"/>
                  </div>
                </div>
                <div class="relative mb-8">
                  <label class="flex  items-center mb-2 text-gray-600 text-base leading-6 font-medium">Email </label>
                  <div class="relative text-gray-500 focus-within:text-gray-900">
                    <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none ">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <input type="text" id="default-search" class="w-full block h-12 pr-5 pl-12 py-2.5 text-lg leading-7 font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-full placeholder-gray-400 focus:outline-none" placeholder="Enter Your Email"/>
                  </div>
                </div>
                <div class="relative mb-8">
                  <label class="flex  items-center mb-2 text-gray-600 text-base leading-6 font-medium">Message </label>
                  <div class="relative ">
                    <textarea class="block w-full h-40 px-4 py-2.5 text-lg leading-7 font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-2xl placeholder-gray-400 focus:outline-none resize-none" placeholder="Write your message"></textarea>
                  </div>
                </div>
                <button class="w-full h-12 rounded-full bg-gradient-to-r from-white via-gray-900 to-amber-300 hover:bg-indigo-900 transition-all duration-700 shadow-sm text-white text-base font-semibold leading-6 flex items-center justify-center">Send message <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
