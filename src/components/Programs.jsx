    ...
    return (
        <div>
            <div class="relative overflow-hidden bg-white pt-16 pb-32 space-y-24">
                <div class="relative">
                    <div class="w-full sm:py-16 py-6 flex-col justify-start items-center gap-2.5 flex">
                        <h2 class="text-center text-gray-900 text-3xl font-bold font-manrope leading-normal">Programs</h2>
                    ...
                    <div class="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8 ">
                        <div class="mx-auto max-w-xl px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0 ">
                            ...
                            <div>
                                <div>
                                    <span class="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-r from-white via-gray-900 to-amber-300">
                        ...
                        <div class="mx-auto max-w-xl px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0 lg:col-start-2">
                            <div>
                                ...
                                <div class="mt-6">
                                    ...
                                    <p class="mt-4 text-lg text-neutral-500">
                                        Not everyone who needs counselling services has access to a psychology center.
                                        Mentheal runs a counselling outreach program to bring counselling services to such people.
                                    </p>
                                    <div class="mt-6">
                                        <a class="inline-flex rounded-lg bg-gradient-to-r from-white via-gray-900 to-amber-300 px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm"
                                            href="/login">
