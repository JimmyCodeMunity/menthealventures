            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
                    <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                        <a href="https://pagedone.io/" class="flex  items-center  space-x-3justify-center lg:justify-start">
                    ...
                    <div class="lg:mx-auto text-left ">
                        ...
                        <ul class="text-sm  transition-all duration-500">
                            <li class="mb-6"><a href="javascript:;" class="text-gray-600 hover:text-gray-900">Virtual Meetings</a></li>
                            <li class="mb-6"><a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Physical Therapy</a></li>
                            <li class="mb-6"><a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Scheduling</a></li>
                            <li><a href="javascript:;" class=" text-gray-600 hover:text-gray-900">AI meetings</a></li>
                        </ul>
                    </div>
                    <div class="lg:mx-auto text-left">
                ...
                <div class="py-7 border-t border-gray-200">
                    <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                        <span class="text-sm text-gray-500 ">©<a href="/">menthealventures</a> {currentYear}, All rights reserved.</span>
                        <div class="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                            <a href="https://x.com/menthealventure" target='_blank' class="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-indigo-600">
                            ...
                            <a href="https://www.instagram.com/menthealventures" target='_blank' class="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-indigo-600">
                            ...
                            <a href="https://www.linkedin.com/company/mentheal-ventures/" target='_blank' class="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-indigo-600">
                            ...
                            <a href="https://youtube.com/@menthealventures" target='_blank' class="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-indigo-600">
                            ...
                            <a href="https://www.facebook.com/menthealventures?mibextid=ZbWKwL" target="_blank" class="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-indigo-600">
                                <svg class="w-[1.25rem] h-[1.25rem] text-white" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M22 12.0732C22 6.5156 17.5228 2 12 2C6.47715 2 2 6.5156 2 12.0732C2 17.0889 5.65686 21.169 10.4375 22V14.6875H7.89844V12.0732H10.4375V10.043C10.4375 7.52982 11.9303 6.18109 14.2142 6.18109C15.3052 6.18109 16.4557 6.37109 16.4557 6.37109V8.82812H15.108C13.7862 8.82812 13.5625 9.5446 13.5625 10.4016V12.0732H16.3359L15.8984 14.6875H13.5625V22C18.3431 21.169 22 17.0889 22 12.0732Z" fill="currentColor" />
                                </svg>
                            </a>
                            <a href="https://whatsapp.com/channel/0029Vb14R126buMRvni8dh28" target="_blank" class="w-9 h-9 rounded-full bg-gray-700 flex justify-center items-center hover:bg-green-600">
                                <svg class="w-[1.25rem] h-[1.25rem] text-white" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M20.52 3.48A11.99 11.99 0 0 0 1 13.01c0 2.11.54 4.17 1.56 5.99L1 23l4.19-1.12a11.99 11.99 0 0 0 5.98 1.56c6.63 0 12-5.37 12-12 0-3.21-1.25-6.22-3.52-8.48ZM12 20a8.01 8.01 0 0 1-4.24-1.18l-.3-.18-2.49.67.66-2.43-.19-.31A8 8 0 1 1 12 20Zm3.76-6.58c-.2-.1-1.18-.58-1.36-.64-.18-.07-.32-.1-.46.1-.13.2-.53.64-.65.78-.12.13-.24.15-.44.05-.2-.1-.86-.32-1.64-1.02-.6-.53-1-1.18-1.12-1.38-.12-.2-.01-.31.09-.42l.32-.38c.1-.1.13-.2.2-.33.07-.13.03-.25-.02-.35s-.46-1.1-.63-1.5c-.17-.4-.34-.35-.46-.36h-.4c-.14 0-.35.05-.54.25-.2.2-.71.69-.71 1.68s.73 1.95.83 2.08c.1.13 1.43 2.2 3.46 3.08 1.28.56 1.78.6 2.42.52.37-.04 1.18-.48 1.35-.95s.17-.86.12-.95c-.05-.08-.18-.13-.38-.23Z" fill="currentColor" />
                                </svg>
                            </a>
